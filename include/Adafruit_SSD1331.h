/*************************************************** 
  ...
  Feb 2017 - code modified by Jochen Peters (alltagshack)
             to run on a feather M0 / Arduino Zero (?) with hardware SPI
  Feb 2026 - code modified by Jochen Peters (alltagshack)
             to run on a ESP32-s3-DevKit-M1 with hardware SPI and without PSRAM
 ****************************************************/
